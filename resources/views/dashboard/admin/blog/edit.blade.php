...
<div class="row">
    <div class="col-12">
        ...
        <div class="box mt-4">
            <form action="/dashboard/admin/blogs/{{ $blog->id }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <input type="text" name="title" id="title" class="input mt-2" value="{{ old('title', $blog->title) }}" placeholder="Input title..." @error('title') is-invalid @enderror>
                        @error('title')
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        <textarea name="description" id="description" class="input mt-2" placeholder="Input description..." @error('description') is-invalid @enderror >{{ old('description', $blog->description) }}</textarea>
                        @error('description')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="row mt-4">
                    <div class="col">
                        ...
                        @enderror
                        <img class="img-preview" id="img-preview" src="{{ $blog->image ? asset('images/'.$blog->image) : '' }}" frameborder="0" style="width: 200px; display: {{ $blog->image ? 'block' : 'none' }}">
                    </div>
                </div>
